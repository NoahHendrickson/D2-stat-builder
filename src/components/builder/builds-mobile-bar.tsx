  ...
  return (
    <div className="pointer-events-none fixed inset-x-0 bottom-0 z-40 lg:hidden">
      <button
        ...
        className={cn(
          "border-border/60 bg-background/95 supports-[backdrop-filter]:bg-background/80 pointer-events-auto flex w-full flex-col gap-2 border-t px-4 py-3 text-left backdrop-blur transition-colors",
      ...
      >
        ...
        <span className="flex items-center gap-3">
          <span className="min-w-0 flex-1">
            <span className="block text-sm font-medium">Builds</span>
